[![build](https://github.com/opspec-pkgs/git.repo.commit-changes/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/git.repo.commit-changes/actions/workflows/build.yml)
